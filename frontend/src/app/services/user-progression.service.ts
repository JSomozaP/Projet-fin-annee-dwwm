/**
 * Streamyscovery - Service de progression utilisateur
 * Copyright (c) 2025 Jeremy Somoza. Tous droits réservés.
 * 
 * Ce service gère la progression des utilisateurs, niveaux, XP,
 * et la synchronisation avec le système de quêtes.
 * 
